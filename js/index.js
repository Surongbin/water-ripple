/* 怕傻丫头看不懂，我都给你备注了
  ctx 是上下文， x是波形左上角坐标x, y是波形左上角坐标y, diameter是波形的最大直径
*/
...
Ripple.prototype = {
  ...
  startAnimationIfLoaded: function () {
...
context.drawImage(document.getElementById('mainImg'), 0, 0)
var ripple = new Ripple(context, 100, 100, 400);
var success = ripple.startAnimationIfLoaded();